...
**When updating memory**: write directly to files under `.claude-memory/` in this repo. Do NOT write to `C:\Users\14350\.claude\projects\f--ImageWR\memory\` — that path is deprecated for this project.
